...
class MainContent extends Component {
    ...
    handleSubmit(event){
        fetch('https://asakuracl.github.io/neographe-react/api/form', {
            method: 'POST',
            headers: {
            ...
            <div className='mainContent'>
                ...
                <section ref={node => this.secondSection = node} className='project' 
                    ...
                    <div className="contact-illustration">
                            <form className="contact-form" onSubmit={this.handleSubmit} action='https://asakuracl.github.io/neographe-react/' method='post'>
